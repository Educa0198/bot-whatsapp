...
const ragContextService_1 = require("./services/ragContextService");
const createApp = () => {
    const app = (0, express_1.default)();
    app.use(express_1.default.json({ limit: "1mb" }));
    const llmService = new llmService_1.LLMService();
    const metaService = new metaWhatsAppService_1.MetaWhatsAppService();
    const ragService = new ragContextService_1.RagContextService();
    const conversationService = new conversationService_1.ConversationService(metaService, llmService, ragService);
